    ...
    return BlocListener<RoomCubit, RoomState>(
      ...
      child: BlocBuilder<QuizCubit, QuizState>(
        builder: (ctx, state) {
          ...
          final myRank = scoreboard.indexWhere((e) => e['id'] == myPlayerId) + 1;
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: Theme.of(context).textTheme.headlineMedium?.copyWith(
                                ...
                                color: isWinner ? const Color(0xFFFFEAA7) : Colors.white,
                              ),
                            ...
                            Expanded(
                              child: scoreboard.isEmpty
                                  ...
                                  : ListView.builder(
                                      ...
                                      itemBuilder: (_, i) {
                                        final entry = scoreboard[i] as Map<String, dynamic>;
                            ...
                            if (isCreator) ...[
                              FilledButton.icon(
                                onPressed: () => ctx.read<RoomCubit>().restartGame(),
