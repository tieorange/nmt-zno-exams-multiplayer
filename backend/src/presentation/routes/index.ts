...
import { createRoom, getRoomState, getRoundState, joinRoom, heartbeat } from '../controllers/RoomController.js';
...
router.get('/rooms/:code/round-state', validateRoomCode, asyncHandler(getRoundState));
